const path = require('path'); // this runs in the node environment, so we can bring in the path library
...
module.exports = {
  ...
  mode: 'development', //was "development" // we can say the string it will or what it will be in the package.json script that we will run.  Lookup process.env.NODE_ENV
  plugins: [
    new HtmlWebpackPlugin({
      template: path.join(__dirname, 'index.html'),
    }),
  ], // first argument is an object- first property is going to be template.  It will have a string index.html as a string as a value
